...
ActiveRecord::Schema.define(:version => 20111010105705) do
  ...
  create_table "weave_translations", :force => true do |t|
    t.integer  "weave_id"
    t.string   "locale"
    t.string   "name"
    t.datetime "created_at"
  ...
  add_index "weave_translations", ["weave_id"], :name => "index_weave_translations_on_weave_id"
